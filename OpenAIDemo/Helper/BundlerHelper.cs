...
namespace OpenAIDemo.Helper
{
    ...
    public static class BundlerHelper
    {
        ...
        /// <summary>
        /// EASON SIMILAR to MVC Bundle. this one load from json file
        /// </summary>
        ...
        public static HtmlString Render(string baseFolder, string bundlePath)
        {
            ...
            {
                inputFiles = inputFiles.Select(file => file.Replace("wwwroot", GlobalContext.SystemConfig.VirtualDirectory)).ToList();
            }
